    ...
    Scaffold(
        ...
        Box(
            ...
            Column(
                ...
                Text(
                    stringResource(R.string.reset_password_title_hero),
                ...
                Text(
                    stringResource(R.string.reset_password_text),
                    fontSize = 16.sp,
                    lineHeight = 22.sp,
                ...
                CustomOutlinedTextField(
                    value = "",
                    onValueChange = {  },
                    placeholderText = stringResource(R.string.reset_password_hint_email),
...
//                    },
                ...
                CustomOutlinedTextField(
                    value = "",
                    onValueChange = {  },
                    placeholderText = stringResource(R.string.reset_password_hint_password),
                    keyboardOptions = KeyboardOptions(
...
//                    },
                ...
                CustomOutlinedTextField(
                    value = "",
                    onValueChange = {  },
                    placeholderText = stringResource(R.string.reset_password_hint_confirm_password),
                    keyboardOptions = KeyboardOptions(
                        keyboardType = KeyboardType.Password,
...
//                    } else {
                        Text(
                            stringResource(R.string.reset_password_reset_button),
